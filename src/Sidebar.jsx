...
function Navbar() {
  ...
  const fetchData = async () => {
    const url = `http://localhost:7000/api/floods/testing9?sDate=2016-04-04&eDate=2017-04-04&CountryName=India&SatelliteName=${selectedValues[0] ? selectedValues[0]:''}&SatelliteName1=${selectedValues[1] ? selectedValues[1]:''}&SatelliteName2=${selectedValues[2] ? selectedValues[2]:''}&SatelliteName3=${selectedValues[3] ? selectedValues[3]:''}&SatelliteName4=${selectedValues[4] ? selectedValues[4]:''}`;
    console.log(url);
  ...
  return (
    <>
     ...
     { floodData.map(nested => nested.flooddata.map(element => {return(
      ...
      <input type='checkbox' onClick={(e)=>{handleGeoJSON(e)}} name={element.footprint} value={element.field1 ? element.field1 :'what'}/>{element.field1} <br/>
      </>
     )}))}
            </div>
            ...
            <div className='Satellites-info'>
              <input onClick={(e)=>handleParams(e)} type="checkbox" id="planet" name="planet" value="Planet" />
              Planet <br />
              <input onClick={(e)=>handleParams(e)} type="checkbox" id="digital" name="digital" value="Digital-Globe" />
              Digital Globe <br />
              <input onClick={(e)=>handleParams(e)} type="checkbox" id="sentinel2" name="sentinal2" value="Sentinel-II" />
              Sentinel-II  <br />
            </div>
            ...
            <div className='Satellites-info'>
              <input onClick={(e)=>handleParams(e)} type="checkbox" id="alos2" name="also2" value="Alos-II" />
              ALOS-II <br />
              <input onClick={(e)=>handleParams(e)} type="checkbox" id="sentinel1" name="sentinel1" value="Sentinel-I" />
              Sentinel-I <br />

            </div>

            <div id="submitbutton">
            <button type="submit" onClick={()=>{setQueryParams(selectedValues)}}>Submit</button>
            </div>
